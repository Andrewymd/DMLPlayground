...
from models.loss import TripletSemiHardLoss
...
def train_triplet_semihard(opt):
    logging.info(opt)
    ...
    logging.info('Average validation of %d runs:\n%s' % (opt.number_of_runs,
                                                         format_results(average_results(run_results))))


if __name__ == '__main__':
    train_triplet_semihard(parse_args())
